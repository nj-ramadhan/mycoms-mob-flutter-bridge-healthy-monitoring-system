...
#define WIFI_SSID "AP-AE-RuangRapat"
#define WIFI_PASSWORD "Net#AE1995_"

// Insert Firebase project API Key
#define API_KEY "AIzaSyBnuKZhZLqNkpF47n0udHdt6hWCO0Ks9VU"

// Insert RTDB URLefine the RTDB URL */
#define DATABASE_URL "https://projek-iot-01-default-rtdb.firebaseio.com/" 
...
void loop() {
  ...
  if (Firebase.ready() && signupOK && (millis() - sendDataPrevMillis > 1000 || sendDataPrevMillis == 0)){
    ...
    // Write Accelerometer Value
    if (Firebase.RTDB.setFloat(&fbdo, "Data/AccelX", gValue.x)){
    ...
    if (Firebase.RTDB.setFloat(&fbdo, "Data/AccelY", gValue.y)){
      Serial.println("PASSED");
      Serial.println("PATH: " + fbdo.dataPath());
      Serial.println("TYPE: " + fbdo.dataType());
    }
    ...
    if (Firebase.RTDB.setFloat(&fbdo, "Data/AccelZ", gValue.z)){
      Serial.println("PASSED");
      Serial.println("PATH: " + fbdo.dataPath());
      Serial.println("TYPE: " + fbdo.dataType());
    }
    ...
    // Write Gyroscope Value
    if (Firebase.RTDB.setFloat(&fbdo, "Data/GyroX", gyr.x)){
      Serial.println("PASSED");
      Serial.println("PATH: " + fbdo.dataPath());
      Serial.println("TYPE: " + fbdo.dataType());
    }
    ...
    if (Firebase.RTDB.setFloat(&fbdo, "Data/GyroY", gyr.y)){
      Serial.println("PASSED");
      Serial.println("PATH: " + fbdo.dataPath());
      Serial.println("TYPE: " + fbdo.dataType());
    }
    ...
    if (Firebase.RTDB.setFloat(&fbdo, "Data/GyroZ", gyr.z)){
      Serial.println("PASSED");
      Serial.println("PATH: " + fbdo.dataPath());
      Serial.println("TYPE: " + fbdo.dataType());
    }
